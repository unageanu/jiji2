...
class BollingerBandsAgent
  ...
  def post_create
    index_graph = graph_factory.create('index',
      :line, :last, ['#779999'])
    bands_graph = graph_factory.create('rate',
      :rate, :last, ['#FF6633', '#FFAA22', '#FFCC11', '#FFEE00', '#FFCC11', '#FFAA22', '#FF6633'])
    ...
    @trader = BollingerBands::Trader.new(
      ...
      broker, index_graph, bands_graph, logger, calculator)
  end
