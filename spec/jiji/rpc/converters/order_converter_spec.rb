...
describe Jiji::Rpc::Converters::OrderConverter do
  ...
  describe '#convert_order_to_pb' do
    it 'converts Order to Rpc::Order' do
      ...
      expect(converted.lower_bound).to eq 109
      expect(converted.upper_bound).to eq 111
      expect(converted.stop_loss).to eq 108
      expect(converted.take_profit).to eq 112
      ...
      expect(converted.price).to eq 0
      expect(converted.expiry).to eq nil
      expect(converted.lower_bound).to eq 0
      expect(converted.upper_bound).to eq 0
      expect(converted.stop_loss).to eq 0
      expect(converted.take_profit).to eq 0
  ...
  describe '#convert_orders_options_from_pb' do
    it 'converts Rpc::OrderOption to order options' do
      ...
      converted = converter.convert_orders_options_from_pb(option)
    ...
    it 'returns nil when an order option is nil' do
      converted = converter.convert_orders_options_from_pb(nil)
      expect(converted).to eq nil
    end
  end
